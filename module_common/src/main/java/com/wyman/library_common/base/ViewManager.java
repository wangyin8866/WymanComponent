...
public class ViewManager {
    ...
    private static List<ISupportFragment> fragmentList;
    ...
    public void addFragment(int index, ISupportFragment fragment) {
    ...
    public ISupportFragment getFragment(int index) {
        if (fragmentList != null) {
    ...
    public List<ISupportFragment> getAllFragment() {
        if (fragmentList != null) {
            return fragmentList;
        }
        return null;
